...
const MatchCard = ({
  ...
  // Obtiene nombres con la función prop
  ...
  return (
    <Box sx={{ p:2, mb:2, border: localResult.saved
      ...
      <Box sx={{ display:'flex', alignItems:'center', gap:1, mb:1}}>
        ...
        <Typography flex={1}>
          {name1}{match.player1.player2 && ` / ${getPlayerName(tournament, match.player1.player2)}`}
        </Typography>
        <Typography>vs</Typography>
        <Typography flex={1} textAlign="right">
          {name2}{match.player2.player2 && ` / ${getPlayerName(tournament, match.player2.player2)}`}
        </Typography>
      </Box>
