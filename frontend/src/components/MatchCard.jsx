  ...
  return (
    <Card
      sx={{
        ...
        borderRadius: 2,
        width: '100%',
        minHeight: { xs: 100, sm: 120 }, // Ensure card grows with content
      }}
    ...
    >
      <CardContent sx={{ p: 0.5, display: 'flex', flexDirection: 'column', gap: 0.5 }}>
                ...
                {localResult.sets?.map((set, idx) => (
                  <Box key={idx} sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                    <TextField
                      ...
                      sx={{ width: 32, minWidth: 32, '& input': { fontSize: '0.75rem', textAlign: 'center', padding: '4px' } }}
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, minWidth: 0 }}>
          ...
          {canEdit && isEditable && !matchResult.saved && isTied && totalSets === 2 && (
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5, flexWrap: 'wrap', minWidth: 0 }}>
              <TextField
                size="small"
                type="number"
          ...
          {canEdit && isEditable && (
            <>
              <Select
                ...
                sx={{ width: { xs: 80, sm: 100 }, minWidth: 80, fontSize: '0.75rem' }}
